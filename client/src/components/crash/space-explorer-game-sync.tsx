    ...
    >
      ...
      <Card className="bg-transparent border-blue-500/30 backdrop-blur-sm">
        ...
        <CardContent className="p-6">
          {/* Primera sección: Juego principal con controles de apuesta */}
          <div className="grid grid-cols-1 gap-6 mb-8">
            ...
            {/* Área de visualización OVNI/juego - MUCHO MÁS GRANDE */}
            <div className="relative h-[600px] rounded-lg border border-blue-500/30 bg-black/60 overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <AnimatePresence mode="wait">
                  {missionState === 'ready' && (
                    ...
                    >
                      <UfoSvg scale={3.5} className="mx-auto mb-6 animate-float" />
                      <p className="text-blue-300 font-digital text-2xl">Listo para explorar el universo</p>
                    </motion.div>
                  )}
                  ...
                  {missionState === 'countdown' && countdown !== null && (
                    <motion.div
                      ...
                      className="text-center"
                    >
                      <UfoSvg scale={3.5} className="mx-auto mb-4 animate-float" />
                      <div className="font-digital text-amber-400 text-8xl font-bold text-shadow-lg">
                        {countdown}
                      </div>
                      <p className="text-blue-300 font-digital mt-2 text-2xl">Preparando para despegue</p>
                    </motion.div>
                  )}
                  ...
                  {missionState === 'returning' && (
                    <motion.div
                      ...
                      className="text-center"
                    >
                      <UfoSvg scale={3.5} className="mx-auto animate-launch" />
                      <motion.div
                        initial={{ scale: 0, opacity: 0 }}
                        animate={{ scale: 1, opacity: 1 }}
                        transition={{ delay: 0.2 }}
                        className="font-digital text-green-500 text-7xl font-bold mt-6 text-shadow-lg"
                      >
              ...
              <div className="absolute bottom-5 left-10 right-10 flex justify-between text-sm text-gray-400">
            ...
            {/* Controles de juego - Mejorando la interfaz y haciéndolos más grandes */}
            <div className="grid grid-cols-2 gap-6 mt-4">
              <div>
                <label className="block text-lg text-blue-300 mb-3 font-mono font-bold">CANTIDAD DE APUESTA</label>
                <div className="flex">
                  <Input 
                    type="number" 
                    value={bet}
                    ...
                    className="bg-blue-950/50 border-blue-500/50 text-xl font-mono h-16"
                  />
                </div>
              </div>
              
              <div>
                <label className="block text-lg text-blue-300 mb-3 font-mono font-bold">AUTO CASHOUT</label>
                <div className="flex items-center gap-3">
                  <Checkbox 
                    checked={isAutoCashoutEnabled} 
                    onCheckedChange={(checked) => setIsAutoCashoutEnabled(!!checked)} 
                    id="auto-cashout"
                    className="border-blue-500/50 h-7 w-7"
                  />
                  <Input 
                    type="number" 
                    value={autoCashout}
          ...
          {/* Segunda sección: Información del juego y estadísticas */}
          ...
          {/* Advertencias */}
          <div className="p-4 rounded-lg border border-yellow-500/40 bg-yellow-950/40 shadow-lg shadow-yellow-900/10 mt-6">
