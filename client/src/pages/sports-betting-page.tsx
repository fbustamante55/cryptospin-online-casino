...
import { Search, Plus, Coins, Star, Clock, ChevronRight } from "lucide-react";
...
export default function SportsBettingPage() {
  ...
  const sportsCategories = [
    { name: t('sports.soccer').toUpperCase(), icon: "/src/assets/soccer.png", color: "#1e88e5" },
    { name: t('sports.basketball').toUpperCase(), icon: "/src/assets/basketball.png", color: "#d32f2f" },
    { name: t('sports.tennis').toUpperCase(), icon: "/src/assets/tennis.png", color: "#ff9800" },
