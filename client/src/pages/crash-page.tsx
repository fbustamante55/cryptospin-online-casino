        ...
        <header className="bg-[#0F1923] border-b border-gray-800 sticky top-0 z-10">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="md:flex flex-1 px-4 justify-center">
              <h1 className="text-xl font-heading font-bold">Crash Game</h1>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-[#1A2634] border-gray-800">
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-2 text-sm text-gray-300">
                      ...
                      <p className="flex items-start">
                        <span className="bg-[#0F1923] text-[#00FFAA] w-5 h-5 rounded-full flex items-center justify-center mr-2 flex-shrink-0">4</span>
                ...
                <Card className="bg-[#1A2634] border-gray-800">
                  <CardContent className="p-4">
                    <h3 className="text-lg font-heading font-semibold mb-3 flex items-center">
                      <Target className="h-5 w-5 mr-2 text-[#00FFAA]" />
                      Strategy Tips
                    </h3>
                    <div className="space-y-2 text-sm text-gray-300">
                      <p className="flex items-start">
                        <span className="text-[#00FFAA] mr-1">•</span>
                          ...
                          return (
                            <div key={game.id} className="flex justify-between items-center py-1.5 border-b border-gray-800 last:border-0">
                              <div className="flex items-center space-x-2">
                                <div className="text-xs bg-[#0F1923] px-2 py-1 rounded flex items-center">
